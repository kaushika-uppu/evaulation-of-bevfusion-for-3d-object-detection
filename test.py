...
# --- START PATCH: FIX WEIGHTS_ONLY ERROR ---
# Force torch.load to default to weights_only=False to support older checkpoints
...
def main():
    ...
    fps = num_samples / total_time_sec
    mean_latency_ms = (total_time_sec / num_samples) * 1000
    print(f"\n==========================================")
    print(f"       INFERENCE LATENCY REPORT           ")
    print(f"==========================================")
    print(f"Total Time:      {total_time_sec:.4f} seconds")
    print(f"Total Samples:   {num_samples}")
    print(f"------------------------------------------")
    print(f"FPS:             {fps:.2f} frames/sec")
    print(f"Mean Latency:    {mean_latency_ms:.2f} ms/frame")
    print(f"==========================================\n")
